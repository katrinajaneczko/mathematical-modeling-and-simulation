...
%   mediumfish.txt and eaterfishhook.txt to run. 
%   
%   DESCRIPTION: It shows an eater which "eats" a series 
%   of four fish and then disappears after eating the last one. 
%
% 03/2022 by Katrina Janeczko

% Parameters
n = [250,100]; % number of cells per dimension
filename{1} = 'eaterfishhook.txt';
pos{1} = [100,69]; % position of object loaded from file (top corner)
filename{2} = 'mediumfish.txt';
pos{2} = [215,80]; % position of object loaded from file (top corner)
filename{3} = 'mediumfish.txt';
pos{3} = [5,70]; % position of object loaded from file (top corner)
filename{4} = 'mediumfish.txt';
pos{4} = [40,70]; % position of object loaded from file (top corner)
filename{5} = 'mediumfish.txt';
pos{5} = [75,70]; % position of object loaded from file (top corner)
