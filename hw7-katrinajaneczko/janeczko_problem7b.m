...
%   dart.txt and honeyfarm.txt to run. 
%   
%   DESCRIPTION: It shows two darts going toward a pattern
%   of 4 hives, then the first dart disappears along with
%   the hive it hits, and then the second disappears along
%   with the beehive it hits. The last 2 beehives remain and 
...
filename{1} = 'honeyfarm.txt';
pos{1} = [200,50]; % position of object loaded from file (top corner)
filename{2} = 'dart.txt';
pos{2} = [210,50]; % position of object loaded from file (top corner)
filename{3} = 'dart.txt';
pos{3} = [230,50]; % position of object loaded from file (top corner)
